      ...
      <div className="month-offline-container">
        ...
        <div className="month-offline-content">
          ...
          <div className="reservation-notice">
            <p className="deadline">⏰ Reservations 2 join close on <strong>April 26th</strong> or when the cohort is filled.</p>
            ...
            <div className="schedule-grid">
              <div className="schedule-card">
                ...
                <ul className="schedule-list">
                  ...
                  <li><span className="star">✰</span> may 9th – 7pm</li>
                  <li><span className="star">✰</span> may 16th – 7pm</li>
                  <li><span className="star">✰</span> may 23rd – 7pm</li>
                  <li><span className="star">✰</span> may 30th – 7pm, <em>graduation</em></li>
                  <li className="special-event"><span className="star">✰</span> june 9th – gallery exhibit & graduation party</li>
                </ul>
              </div>
