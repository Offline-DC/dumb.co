  ...
  /* Measured off flipphone_short.png (560x698) by build/trace_screen.py. These drive
  ...
  const ART = {
    ratio: 698 / 560,
    drawnTop: 0.0387, drawnH: 0.8883, drawnW: 0.4286,
    keysBottom: 0.7980,   // just under the d-pad; anything lower crops off
    screenH: 0.3467,            // the screen aperture, as a fraction of the art
  };
  /* <<< art */
  const BP = 760;
